...
// Logical Operators
if (newBackpack.volume > 20 && newBackpack.pocketNum > 2) {
  console.log("Big backpack with lots of pockets!"); // Output: Big backpack with lots of pockets!
} else if (newBackpack.volume > 20 && newBackpack.pocketNum <= 2) {
  console.log("Big backpack with few pockets!"); // Output: Big backpack with few pockets!
} else if (newBackpack.volume <= 20 && newBackpack.pocketNum > 2) {
  console.log("Small backpack with lots of pockets!"); // Output: Small backpack with lots of pockets!
} else {
  console.log("Small backpack with few pockets!"); // Output: Small backpack with few pockets!
}